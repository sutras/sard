<template>
  <doc-page gray title="可选择的">
    <s-list>
      <s-list-item hover arrow title="设置选中的节点" @click="setCheckedKeys" />
      <s-list-item hover arrow title="获取选中的节点" @click="getCheckedKeys" />
      <s-list-item hover arrow title="清空" @click="clear" />
    </s-list>
