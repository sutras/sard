...
export const Input = (props: InputProps) => {
  ...
  const [setBlurVisibleLater] = useSetTimeout(() => {
          ...
          <View
            className={classNames(
              ...
              bem.em(
                'clear',
                'hide',
                showClearOnlyFocus && !(focused || innerFocused || blurVisible),
              ),
            )}
            onClick={handleClear}
            onTouchStart={handleTouchStart}
            {...(isPC() ? { onMouseDown: handleTouchStart } : null)}
          >
            {clear || (
              <Icon name="x-circle-fill" className={bem.e('clear-icon')} />
            )}
          </View>
        )}
