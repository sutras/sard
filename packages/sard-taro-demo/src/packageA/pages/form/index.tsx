    ...
    <Page className="page-form">
      ...
      <Demo title="基础使用">
        <Form
          ...
          initialValues={{}}
          form={form}
          style={{ '--sar-form-item-padding-x': 0 }}
          scrollToFirstError
          disabled={disabled}
        >
          <Form.Item
              ...
              <Popout.Outlet>
                {({
                  ...
                  <Input
                    ...
                    placeholder="请选择省市区"
                    append={
                      <Icon color="#ccc" name="bi-caret-right-fill"></Icon>
                    }
                    value={
                      (value?.length &&
          ...
          <Form.Item label="现住址" name="address" rules={[{ required: true }]}>
            <Input
              inlaid
              clearable
              type="textarea"
          ...
          <Form.Item label="学历" name="education" rules={[{ required: true }]}>
            <Popout title="请选择学历">
              <Popout.Outlet>
                {({
                  value,
