...
可通过 css 变量 `--s-slide-verify-theme-color` 来设置想要的主题色。
...
| start  | 拖拽开始时触发                                         | `(event: TouchEvent) => void` |
| move   | 拖拽移动时触发                                         | `(event: TouchEvent) => void` |
| end    | 拖拽结束时触发                                         | `(event: TouchEvent) => void` |
...
| CSS 变量                         | 值                              |
| -------------------------------- | ------------------------------- |
| `--s-slide-verify-height`        | `var(--s-content-height-sm)`    |
| `--s-slide-verify-bg`            | `var(--s-fill-color-secondary)` |
| `--s-slide-verify-theme-color`   | `var(--s-color-success)`        |
| `--s-slide-verify-border-radius` | `var(--s-border-radius-sm)`     |
| `--s-slide-verify-border-color`  | `var(--s-text-color-fourth)`    |
| `--s-slide-verify-font-size`     | `var(--s-font-size)`            |
| `--s-slide-verify-icon-size`     | `var(--s-size-xl)`              |
