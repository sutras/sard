...
<<< @demo/read-more/demo/Basic.vue

### 收起时最大高度

可以使用 `max-height` 设置收起时的最大高度。

<<< @demo/read-more/demo/MaxHeight.vue

### 按钮文案

使用 `open-text` 和 `close-text` 设置展开状态和收起状态时的按钮文案。

<<< @demo/read-more/demo/Text.vue

### 隐藏收起按钮

设置 `hide-close` 后，在展开时不会再显示收起按钮。

<<< @demo/read-more/demo/HideClose.vue
...
| visible       | 控制展开和收起                                                 | boolean | false  |
| keep-location | 收起时保持按钮下面的内容在屏幕中原来的位置，只可用在页面滚动中 | boolean | true   |
...
| CSS 变量                          | 值                                                                                                                   |
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `--s-read-more-shadow-max-height` | `80%`                                                                                                                |
| `--s-read-more-shadow-height`     | `100px`                                                                                                              |
| `--s-read-more-shadow-bg`         | `linear-gradient(to bottom, rgba(var(--s-bg-color-container-rgb), 0), rgba(var(--s-bg-color-container-rgb), 1) 95%)` |
